...
namespace VTC
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //toolTip1.SetToolTip(this.tabPage1, "На овом табу можете препаковати MKV-->MP4 и обрнуто. Ако изаберете MKV, програм ће аутоматски изабрати MP4 и обрнуто.");
            ...
            //toolTip2.SetToolTip(this.tabPage2, "На овом табу можете направити пуну конверзију различитих формата (AVI, DIVX, XVID, WMV, OGG, FLAC, итд.) у MKV,MP4,AAC,MP3. Фајлове бирате појединачно (дугме горе лијево) или више одједном (дугме горе десно) и додајете их на листу са десне стране. Можете мијењати листу ручно, као и ffmgeg команду у прозорчићу лијево. Такође можете извући само слику или звук и додати титл у видео фајл.");
            ...
            toolTip4.SetToolTip(this.buttonOutTransFile, "Изаберите путању гдје ћете снимити резултат конверзије. Име фајла је аутоматски одређено тако ШТО ЋЕ СЕ ДОДАТИ .1 НА ПОСТОЈЕЋЕ ИМЕ које ћете изабрати након што одредите гдје снимате фајл. Ако не изаберете гдје ћете га сачувати, биће аутоматски сачуван у истом фолдеру као и оргинални фајл.");
            ...
            //toolTip9.SetToolTip(this.buttonStartQueue, "Кад направите листу за кодовање, кликните да се изврше редом један по један. Доле можете пратити извршавање задатака.");
            ...
            //toolTip11.SetToolTip(this.buttonSellectAllQueue, "Кликните да означите задатке за скидање са листе. Ово их неће уклонити. Дугме Бриши ће их обрисати неповратно са листе.");
            ...
            //toolTip13.SetToolTip(this.buttonDeleteQueue, "Кликните да обришете означене задатке. Означити их можете или појединачним кликтањем на листи или думетом Означи.");
            ...
            //toolTip14.SetToolTip(this.buttonInputConvFile, "Изаберите улазне фајлове различитих видео или аудио формата. Обратите пажњу на филтере код бирања фајлова. Зависно од формата улазног фајла, биће изабран формат излазног, нпр. ако је аудио фајл, биће изабран MP3, итд. Можете такође ОДВУЋИ ВИШЕ ФАЈЛОВА НА ОВО ДУГМЕ.");
            ...
            //toolTip15.SetToolTip(this.buttonOutConvFile, "Изаберите путању гдје ћете сачувати конвертоване фајлове. Тек након тога треба изабрати фајлове које шелите да конвертујете!");
            ...
            //toolTip16.SetToolTip(this.buttonMultiConvFiles, "Изаберите ВИШЕ ФАЈЛОВА за конверзију, али имајте на уму да ће СВИ БИТИ КОДОВАНИ СА ИСТИМ ОПЦИЈАМА КОЈЕ СТЕ ПРИЈЕ ТОГА ИЗАБРАЛИ!!! Листа ће се аутоматски попунити (ово је за ултра, мега гига брзу конверзију). Можете такође да превучете фајлове ба ово дугме!");
            ...
            //toolTip18.SetToolTip(this.richTextBoxConv, "Кад мијењате опције, мијења се и команда испод. Можете ручно мијењати опције у прозору и онда кликнути Додај на листу.");
            ...
            //toolTip19.SetToolTip(this.buttonAddBatchConv, "Кад изаберете опције, кликните да додате задатак на листу десно. Након тога опције остају за слиједећи задатак или их можете промијенити.");
            ...
            //toolTip20.SetToolTip(this.dataGridViewBatch, "Задаци се приказују у овој табели. Можете их брисати, додавати или мијењати директно у табели. Кад желите да прекодујете све задатке, кликните на Старт.");
            ...
            //toolTip20.SetToolTip(this.dataGridViewBatch, "Изаберите ако желите да извучете само звук из фајла.");
            ...
            //toolTip23.SetToolTip(this.radioButtonMKV, "Фајл ће бити сачуван у формату MP4.");
            ...
            //toolTip28.SetToolTip(this.radioButtonCopyVideo, "Видео ће бити копиран у излазни фајл без промјене. Корисно ако улазни фајл није MP3, па једноставно прекодујете аудио.");
            ...
            //toolTip28.SetToolTip(this.radioButtonCopyVideo, "Битска брзина за аудио. Занемарено ако се изабере опција Ориг.");
            ...
            //toolTip30.SetToolTip(this.comboBoxPreset, "Важна опција за квалитет и величину фајла. Ако желите мањи фајл бирајте што спорије (slow).");
            ...
            //toolTip31.SetToolTip(this.comboBoxQuality, "Најважнија опција за квалитет видеа. За ХД филмове 23 је одлично, за ХД са телефона, 25-26 даје мали фајл доброг квалитета, за СД филмове 20 је одлично, 22 даје мали фајл доброг квалитета. Мало испробајте да видите шта вам одговара, па онда увијек користите те вриједности до којих дођете емпиријски.");
            ...
            //toolTip32.SetToolTip(this.buttonAddSubtitle, "Додаје титл из вањског .SRT фајла у убацује га у видео. Корисно за репродукцију на неким уређајима или кад желите да држите само један фајл без додатних екстерних титлова.");
