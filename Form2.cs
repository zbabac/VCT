...
namespace VTC
{
    ...
    {
        public Form2(string pass_video_info, string pass_audio_info, string  pass_subtitle_info, string pass_labelFileName2, string pass_labelFormat2, string pass_labelDuration2, string pass_labelSize2, string pass_labelvideobitrate)
        {
            InitializeComponent();
